...
class RaxmlCommandsRunner:
    ...
    def jobEnded(self, job):
        ...
        text = job.gene + " " + str(job.nodes)
        self._svgWriter.drawRec(100 * job.threadIndex, job.startTime - self._startTime, 100 * job.getThreads(), job.endTime - job.startTime, text)
